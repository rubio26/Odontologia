...
interface ToothProps {
  id: number;
  state: Record<string, string>; // surface -> state (e.g., 'caries', 'healthy')
  onClick: (id: number, surface: string) => void;
}

export const Tooth: React.FC<ToothProps> = ({ id, state, onClick }) => {
  return (
